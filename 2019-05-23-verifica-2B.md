...
DSP è l'acronimo di digital signal porcessing

##### 2. Cos'è un linguaggio di programmazione funzionale? [1/10]

il linguaggio di programazzione funzionale è uno stile di programmazione ,caraterizzato da dei codici che defisce il programma stesso,che assume la forma di una serie di funzioni matematiche
